      ...
      >
        ...
        <div className="mt-8 space-y-6">
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs sm:text-sm text-slate-600 dark:text-slate-300 ml-8 leading-relaxed">
          ...
          <div className="space-y-2">
            ...
            <div className="text-xs sm:text-sm text-slate-600 dark:text-slate-300 ml-8 leading-relaxed space-y-2">
              <p>In your repository on GitHub:</p>
              <ol className="list-decimal list-inside space-y-1 bg-slate-100 dark:bg-slate-950/70 p-3.5 rounded-xl border border-slate-200 dark:border-slate-800">
                <li>
